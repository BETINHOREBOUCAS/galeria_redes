...
class PostHandler {
    ...
    public function _postListToObject($postList, $loggedUserId) {
        ...
        foreach ($postList as $postItem) {
            ...
            //self -> quer dizer que pega o posthandle
            $newPost->liked = self::isLiked($postItem['id'], $loggedUserId);

            // 4.2 preencher informações de comentarios
    ...
    public function getUserFeed($idUser, $page, $loggedUserId) {
        $perPage = 2;
    ...
    public static function getHomeFeed($idUser, $page) {
        ...
        // Tradução: Selecione tudo de UserRealation onde user_from = $idUser
        ...
        // Tradução: Selecione tudo de post onde em id_user tenha 5,4,3.
    ...
    public function getPhotosFrom($idUser) {
        ...
        foreach ($photosData as $photo) {
            ...
            $newPost->create_at = $photo['created_at'];
